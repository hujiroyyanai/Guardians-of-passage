...
#define nrn_init _nrn_init__Glycine_DynSyn
#define _nrn_initial _nrn_initial__Glycine_DynSyn
#define nrn_cur _nrn_cur__Glycine_DynSyn
#define _nrn_current _nrn_current__Glycine_DynSyn
#define nrn_jacob _nrn_jacob__Glycine_DynSyn
#define nrn_state _nrn_state__Glycine_DynSyn
#define _net_receive _net_receive__Glycine_DynSyn 
#define state state__Glycine_DynSyn 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 Glycine_DynSyn /Users/royyanai/Documents/repos/repo_with_michael/mods/Glycine_DynSyn.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Glycine receptor with pre-synaptic short-term plasticity ";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/royyanai/Documents/repos/repo_with_michael/mods/Glycine_DynSyn.mod";
static const char* nmodl_file_text = 
  "TITLE Glycine receptor with pre-synaptic short-term plasticity \n"
  "\n"
  "\n"
  "COMMENT\n"
  " Glycine receptor conductance using a dual-exponential profile\n"
  "Pre-synaptic short-term plasticity based on Fuhrmann et al, 2002\n"
  "\n"
  "Written by Paulo Aguiar and Mafalda Sousa, IBMC, May 2008\n"
  "pauloaguiar@fc.up.pt (modified slightly from GABAa_DynSyn by Tianhe Zhang--2012); mafsousa@ibmc.up.pt\n"
  "ENDCOMMENT\n"
  "\n"
  "\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS Glycine_DynSyn	\n"
  ...
  "	tau_decay = 10.0  (ms)  : IMPORTANT: tau_rise < tau_decay.  Foreman (1976) early component and Moore et. al. (2002)\n"
  ...
  "	e         = -70.0 (mV)  : Glycine synapse reversal potential\n"
  "}\n"
  "     \n"
  "\n"
  "ASSIGNED {\n"
