...
#define _f_rate _f_rate__KDR 
#define rate rate__KDR 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 KDR /Users/royyanai/Documents/repos/repo_with_michael/mods/KDR.mod\n");
...
double alp (  double _lv ) {
 ...
 _lv = _lv ;
   ...
   _lalp = _lq10 * .069 * expM1 ( _threadargscomma_ - _lv - 5.0 , 10.0 ) ;
...
double bet (  double _lv ) {
 ...
 _lv = _lv ;
   _lq10 = pow( 3.0 , ( ( celsius - 23.0 ) / 10.0 ) ) ;
   _lbet = _lq10 * .024 * exp ( ( - _lv - 1.0 ) / 30.0 ) ;
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 41 in file KDR.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/royyanai/Documents/repos/repo_with_michael/mods/KDR.mod";
static const char* nmodl_file_text = 
