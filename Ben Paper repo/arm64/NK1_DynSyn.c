...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 NK1_DynSyn /Users/royyanai/Documents/repos/repo_with_michael/mods/NK1_DynSyn.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "(very)-Empirical model for the effect of NK1 receptor activation";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/royyanai/Documents/repos/repo_with_michael/mods/NK1_DynSyn.mod";
static const char* nmodl_file_text = 
