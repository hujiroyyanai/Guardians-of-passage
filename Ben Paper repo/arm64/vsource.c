...
#define nrn_init _nrn_init__Vsource
#define _nrn_initial _nrn_initial__Vsource
#define nrn_cur _nrn_cur__Vsource
#define _nrn_current _nrn_current__Vsource
#define nrn_jacob _nrn_jacob__Vsource
#define nrn_state _nrn_state__Vsource
#define _net_receive _net_receive__Vsource 
#define icur icur__Vsource 
#define vstim vstim__Vsource 
...
#define toff _p[1]
#define toff_columnindex 1
#define amp _p[2]
#define amp_columnindex 2
#define i _p[3]
#define i_columnindex 3
#define vc _p[4]
#define vc_columnindex 4
#define on _p[5]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 Vsource /Users/royyanai/Documents/repos/repo_with_michael/mods/vsource.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/royyanai/Documents/repos/repo_with_michael/mods/vsource.mod";
static const char* nmodl_file_text = 
  "TITLE vsource.mod\n"
  "COMMENT\n"
