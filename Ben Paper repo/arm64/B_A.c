...
#define nrn_init _nrn_init__B_A
#define _nrn_initial _nrn_initial__B_A
#define nrn_cur _nrn_cur__B_A
#define _nrn_current _nrn_current__B_A
#define nrn_jacob _nrn_jacob__B_A
#define nrn_state _nrn_state__B_A
#define _net_receive _net_receive__B_A 
#define _f_rates _f_rates__B_A 
#define rates rates__B_A 
#define states states__B_A 
...
#define nalpha _p[12]
#define nalpha_columnindex 12
#define nbeta _p[13]
#define nbeta_columnindex 13
#define halpha _p[14]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_B_A", _hoc_setdata,
 "rates_B_A", _hoc_rates,
 "trap_B_A", _hoc_trap,
 0, 0
};
#define trap trap_B_A
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 B_A /Users/royyanai/Documents/repos/repo_with_michael/mods/B_A.mod\n");
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
   nalpha = 0.032 * trap ( _threadargscomma_ - _lv - 64.0 - 0.0 , 6.0 ) ;
   nbeta = 0.203 * exp ( ( - _lv - 40.0 - 0.0 ) / 24.0 ) ;
   ninf = nalpha / ( nalpha + nbeta ) ;
   ntau = 1.0 / ( nalpha + nbeta ) / tadj ;
   halpha = 0.05 / ( exp ( ( _lv + 86.0 + 0.0 ) / 10.0 ) + 1.0 ) ;
   hbeta = 0.05 / ( exp ( ( - _lv - 86.0 - 0.0 ) / 10.0 ) + 1.0 ) ;
   hinf = halpha / ( halpha + hbeta ) ;
   htau = 1.0 / ( halpha + hbeta ) / tadj ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/royyanai/Documents/repos/repo_with_michael/mods/B_A.mod";
static const char* nmodl_file_text = 
