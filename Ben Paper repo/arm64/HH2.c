...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "k_ion");
 	...
 	ivoc_help("help ?1 HH2 /Users/royyanai/Documents/repos/repo_with_michael/mods/HH2.mod\n");
...
static int  evaluate_fct (  double _lv ) {
 ...
 _lv2 = _lv - vtraub ;
   ...
   m_inf = _la / ( _la + _lb ) ;
   _la = 0.182 * exp ( ( 17.0 - _lv2 - _lvh ) / 18.0 ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/royyanai/Documents/repos/repo_with_michael/mods/HH2.mod";
static const char* nmodl_file_text = 
